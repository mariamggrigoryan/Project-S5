...
<div class="footer3" id="2">
  ...
  <p><a href="mailto:info@mysite.com">info@mysite.com</a></p>
	...
	if (`${data.avatarUrl}` == "null") {
		profilePic.innerHTML += `<img src="../../Pics/avatarurl.jpg" alt="prof img" id = "prof"  >`;
	} else {
		profilePic.innerHTML += `<img src="${data.certificate}" alt="prof img" id = "prof" >`;
	}
	...
	document.getElementById("prof").style.minWidth = "125ox";
	document.getElementById("prof").style.minHeight = "125px";
	document.getElementById("prof").style.borderRadius = "50%";
	document.getElementById("prof").style.boxShadow = "0px 0px 5px 2px #634F40";
